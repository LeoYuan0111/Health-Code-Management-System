...
public class Generator {
    ...
    // 表名,多个表使用英文逗号分割
    private static final String[] TBL_NAMES = {"account"};//, "person", "vaccination_record", "test_record", "tube", "vaccine", "health_code", "place_code", "place_visit", "test_position", "test_time", "color_change", "authorize", "complain"};
